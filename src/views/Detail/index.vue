          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd
                  changepirce="0"
                  :class="{ active: i.isChecked == '1' }"
                  v-for="i in item.spuSaleAttrValueList"
                  :key="i.id"
                  @click="checkedChange(i, item.spuSaleAttrValueList)"
                >
                  {{ i.saleAttrValueName }}
                </dd>
              </dl>
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                />
                <a href="javascript:" class="plus" @click="skuNumAdd">+</a>
                <a href="javascript:" class="mins" @click="skuNumDec">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    getGoodInfo(id) {
      this.$store.dispatch("getGoodInfo", id);
    },
    checkedChange(val, arr) {
      arr.forEach((item) => {
        item.isChecked = 0;
      });
      val.isChecked = 1;
